...
abstract class ConstantesGenericasUtil
{
    ...
    public const TIPO_GET = ['USUARIOS', 'HISTORICO', 'RANKING'];
    public const TIPO_POST = ['USUARIOS', 'LOGIN', 'DRINK'];
    ...
    public const MSG_ERRO_EMAIL_EXISTENTE = 'Email já existente!';
    public const MSG_USUARIO_NAO_EXISTE = 'Usuário não existe!';
    public const MSG_ERRO_CAMPO_OBRIGATORIO = 'Todos os campos são obrigatórios!';
